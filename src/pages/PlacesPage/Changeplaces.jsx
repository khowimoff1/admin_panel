...
const Changeplaces = ({ changeModal, changeItems, getPlaces }) => {
    ...
    const handleChange = (e) => {
      ...
      fetch(`https://realauto.limsa.uz/api/locations/${changeItems.id}`, {
        method: "PUT",
        headers: {
      ...
      <div className="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
        <div className="p-6 bg-white rounded-lg lg:w-1/3">
          <div className="flex items-center justify-between">
            <h1 className="text-xl font-semibold">Edit Locations</h1>
            <button
              onClick={changeModal}
