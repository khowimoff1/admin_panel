...
const ChangeModal = ({ changeModal, changeItems, getCategories }) => {
    const [nameEn, setNameEn] = useState(changeItems.name_en || "");
    const [nameRu, setNameRu] = useState(changeItems.name_ru || "");
    const [file, setFile] = useState(null);
  
    const handleChange = (e) => {
      e.preventDefault();
  
      if (!nameEn || !nameRu || !file) {
      ...
      fetch(`https://realauto.limsa.uz/api/categories/${changeItems.id}`, {
        method: "PUT",
        headers: {
